package com.stkj.cashier.login.helper;
...
public enum LoginHelper {
    ...
    public void saveUserInfo(UserInfo userInfo) {
        ...
        if (activity instanceof MainActivity) {
            ...
            mainActivity.getWeakRefHolder(ScreenProtectHelper.class).setForbidScreenProtect(false);
        }
    }
    ...
    public void clearUserInfo() {
        ...
        if (activity instanceof MainActivity) {
            ...
            mainActivity.getWeakRefHolder(ScreenProtectHelper.class).setForbidScreenProtect(true);
        }
        this.userInfo = null;
        MMKV mmkv = MMKV.mmkvWithID(MMKV_NAME);
